...
* **interfaces/**
    * Houses shared TypeScript contracts (`BaseEntity`, `PaginatedQuery`, `DomainServiceContract`, etc.) that every domain can extend to keep APIs and DTOs consistent.
    * [interfaces.md](/src/interfaces/interfaces.md) - Examples and guidance for wiring domain services into the shared contracts.
